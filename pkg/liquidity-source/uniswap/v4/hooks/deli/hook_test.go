...
func TestCalcAmountOut(t *testing.T) {
	...
	testutil.TestCalcAmountOut(t, poolSim, map[int]map[int]map[string]string{
		0: {
			1: {
				"12936925243928912": "14440",
				"13145039951151962": "14680",
			},
		},
		1: {
			0: {
				"14650": "12772905053096678",
				"14885": "12975766058959672",
			},
		},
	})
}
...
func Test_CloneState_UpdateBalance(t *testing.T) {
	...
	assert.Equal(t, bignumber.NewBig10("14440"), result.TokenAmountOut.Amount)
	...
	require.NoError(t, err)
	assert.Equal(t, bignumber.NewBig10("14160"), result.TokenAmountOut.Amount)
}
