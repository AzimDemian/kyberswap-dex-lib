...
func (t *Tracker) fetchRPCDataBatch(
	ctx context.Context,
	pools []entity.Pool,
	blockNumber uint64,
...
func (t *Tracker) queryTicksFromRPCBatch(
	ctx context.Context,
...
func (t *Tracker) mergeTicksFromExtraAndRefetch(
	p entity.Pool,
...
func (t *Tracker) getAffectedTickIdsFromLogsBatch(logs []ethtypes.Log) ([]int, error) {
	...
	for _, event := range logs {
		...
		case abis.UniswapV3PoolABI.Events["Mint"].ID,
			abis.UniswapV3PoolABI.Events["Burn"].ID:
